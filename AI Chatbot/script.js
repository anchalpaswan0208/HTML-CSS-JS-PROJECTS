...
//API Setup
const API_KEY="AIzaSyBIojiEsvEd_R3DUKplKjgmHb3kOrwT3ow";
const API_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${API_KEY}`; //Replace with actual API endpoint
...
//Create messge element with dynamic classes and return it
...
//Initialize Emoji Picker from Emoji Mart selection
